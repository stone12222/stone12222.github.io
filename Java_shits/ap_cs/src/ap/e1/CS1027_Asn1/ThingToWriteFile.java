...
/**
 * ThingToWriteFile makes file writing simpler. It allows information to be
 * written one line at a time to a data file
 * 
 * @author CS1027
 */
public class ThingToWriteFile {
	...
	/**
	 * Constructs the object that controls file writing Exits gracefully if file
	...
	/**
	 * Writes a line to the file Exits gracefully if an error occurs while
	 * reading the file
	 * 
	 * @param line
